                ...
                <div class="dropdown  custom-dropdown-icon">
                    <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><img
                            src="{{ asset('assets_' . assetLang()) }}/assets/img/{{ app()->getLocale() }}.png"
                            class="flag-width" alt="flag"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                            @if (auth('admin')->user()->image)
                                <img src="{{ displayImage(auth('admin')->user()->image) }}" class="img-fluid mr-2"
                                    alt="avatar">
                            @else
                                <img src="{{ displayImage(app('settings')['logo']) }}" class="img-fluid mr-2"
                                    alt="{{ __('admin.logo') }}">
                            @endif
                            <div class="media-body">
                    ...
                    <div class="dropdown-item">
                        <a href="{{ route('admin.profile.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                <circle cx="12" cy="7" r="4"></circle>
                            </svg> <span>{{ __('admin.profile') }}</span>
                        </a>
                    </div>
                    <div class="dropdown-item">
