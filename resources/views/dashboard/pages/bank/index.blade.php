                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive mb-2">
                                            <div class="col-12 mx-auto border">
                                                <form action="{{ route('admin.banks.search') }}" method="GET" class="p-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" value="{{ request()->get('account_owner') }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" value="{{ request()->get('iban_number') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (auth('admin')->user()->hasAnyPermission(['banks.update']))
                                                    <form method="POST" action="{{ route('admin.banks.updateStatus', $bank->id) }}">
                                                        @csrf
                                                        <button
                                                            class="{{ $bank->status->badge() }} btn-sm btn-alert">{{ $bank->status->lang() }}</button>
                                                    </form>
                                                @else
                                                    <span class="{{ $bank->status->badge() }}">{{ $bank->status->lang() }}</span>
                                                @endif
                                            </td>
                                            @if (auth('admin')->user()->hasAnyPermission(['banks.update', 'banks.delete', 'plan_transaction.view']))
