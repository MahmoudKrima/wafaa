                    ...
                    <div class="widget-header">
                        <div class="row mb-4">
                            <div class="col-12 d-flex justify-content-between align-items-center">
                                ...
                                <x-back-button route="{{ route('admin.partners.index') }}" />
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select name="status" class="form-control" id="statusInput">
                                                    @foreach ($status as $stat)
                                                        <option @selected($stat->value == old('status', $partner->status->value))
                                                            value="{{ $stat->value }}">
                                                            {{ $stat->lang() }}
                                                        </option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-6 mb-3 d-flex align-items-center">
                                                <img width="200px" height="200px" src="{{ displayImage($partner->image) }}"
                                                    alt="partner">
                                            </div>
