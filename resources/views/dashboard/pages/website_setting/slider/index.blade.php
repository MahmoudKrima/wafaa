                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4 style="padding: 30px 0 15px 0;">{{ trans('admin.sliders') }}</h4>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-0"
                                                    ...
                                                    {{ $slider->subtitle ?? __('admin.n/a') }}
                                                </p>
                                            </td>
                                            <td>
                                                @if ($slider->button_text && $slider->button_url)
                                                    <a href="{{ $slider->button_url }}"
                                                        target="_blank" class="btn btn-primary btn-sm">{{ $slider->button_text }}</a>
                                                @else
                                                    {{ __('admin.n/a') }}
                                                @endif
                                            </td>
                                            <td>
                                                @if (auth('admin')->user()->hasAnyPermission(['sliders.update']))
                                                    <form method="POST"
                                                        action="{{ route('admin.sliders.updateStatus', $slider->id) }}">
                                                        @csrf
                                                        <button
                                                ...
                                                @else
                                                    <span
                                                        class="{{ $slider->status->badge() }}">{{ $slider->status->lang() }}</span>
                                                @endif
                                            </td>
                                            @if (auth('admin')->user()->hasAnyPermission(['sliders.update', 'sliders.delete']))
                                                <td class="text-center">
                                                    <div class="action-btns d-flex justify-content-center">
                                                        ...
                                                        <a href="{{ route('admin.sliders.edit', $slider->id) }}"
                                                            ...
                                                            title="{{ __('admin.edit_slider') }}" style="margin-right: 10px;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p id="descriptionModalBody" class="mb-0"></p>
                </div>
    ...
    <script>
        (function ($) {
            ...
            $('#descriptionModal').on('show.bs.modal', function (event) {
                ...
                $(this).find('#descriptionModalBody').text(description);
            });
        })(jQuery);
    </script>
@endpush