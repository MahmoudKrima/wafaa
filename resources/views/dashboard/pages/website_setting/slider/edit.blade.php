                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="button_url" id="button_url" class="form-control"
                                                    placeholder="{{ __('admin.button_url') }}"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="button_text" id="button_text" class="form-control"
                                                    placeholder="{{ __('admin.button_text') }}"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    ...
                                                    @foreach ($status as $stat)
                                                        <option @selected($stat->value == old('status', $slider->status->value))
                                                            value="{{ $stat->value }}">{{ $stat->lang() }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3 d-flex align-items-center">
                                                <img width="200" height="200" src="{{ displayImage($slider->image) }}"
                                                    alt="{{ $slider->title }}">
                                            </div>
                                        </div>
                                    </div>
