                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <form action="{{ route('admin.terms.update', $term->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="policy_description_ar"
                                                    class="text-dark">{{ __('admin.policy_description_ar') }}</label>
                                                <textarea type="text" name="policy_description_ar"
                                                    id="policy_description_ar" class="form-control editor"
                                                    placeholder="{{ __('admin.policy_description_ar') }}"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="policy_description_en"
                                                    class="text-dark">{{ __('admin.policy_description_en') }}</label>
                                                <textarea type="text" name="policy_description_en"
                                                    id="policy_description_en" class="form-control editor"
                                                    placeholder="{{ __('admin.policy_description_en') }}"
