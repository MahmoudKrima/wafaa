                                        ...
                                        <div class="row">
                                            <div class="col-6 mb-3">
                                                ...
                                                <input type="text" name="name_ar" id="name_ar" class="form-control"
                                                    value="{{ old('name_ar', $testimonial->getTranslation('name', 'ar')) }}">
                                            </div>
                                            <div class="col-6 mb-3">
                                                <label for="name_en"
                                                    class="text-dark">{{ __('admin.name_en') }}</label>
                                                <input type="text" name="name_en" id="name_en" class="form-control"
                                                    value="{{ old('name_en', $testimonial->getTranslation('name', 'en')) }}">
                                            </div>
                                            <div class="col-6 mb-3">
                                                ...
                                                <input type="text" name="job_title_ar" id="job_title_ar" class="form-control"
                                                    value="{{ old('job_title_ar', $testimonial->getTranslation('job_title', 'ar')) }}">
                                            </div>
                                            <div class="col-6 mb-3">
                                                ...
                                                <input type="text" name="job_title_en" id="job_title_en" class="form-control"
                                                    value="{{ old('job_title_en', $testimonial->getTranslation('job_title', 'en')) }}">
                                            </div>
                                            <div class="col-12 mb-3">
                                                <label for="review_ar"
                                                    class="text-dark">{{ __('admin.review_ar') }}</label>
                                                <textarea name="review_ar" id="review_ar" class="form-control"
                                                    rows="3">{{ old('review_ar', $testimonial->getTranslation('review', 'ar')) }}</textarea>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <label for="review_en"
                                                    class="text-dark">{{ __('admin.review_en') }}</label>
                                                <textarea name="review_en" id="review_en" class="form-control"
                                                    rows="3">{{ old('review_en', $testimonial->getTranslation('review', 'en')) }}</textarea>
                                            </div>
                                            <div class="col-6 mb-3">
                                                <label for="rate"
                                            ...
                                            <div class="col-6 mb-3">
                                                ...
                                                <select name="status" id="statusInput" class="form-control">
                                                    @foreach ($status as $stat)
                                                        <option @selected($stat->value == old('status', $testimonial->status->value))
                                                            value="{{ $stat->value }}">
                                                            {{ $stat->lang() }}
                                                        </option>
                                                    @endforeach
