            ...
            <div class="row align-items-center">
                <div class="col-xl-9 col-lg-9 wow fadeInUp animated" data-wow-delay="300ms">
                    <div class="about-content-wrap">
                        ...
                        <p>
                            في إم دبليو إكسبريس نؤمن أن النجاح لا يتحقق إلا بالتعاون والشراكة الفعّالة.
ولذلك نفخر بشركائنا من شركات الشحن المحلية والدولية الذين يساهمون معنا في تقديم أفضل الحلول اللوجستية لعملائنا.
إن ثقتهم ودعمهم المستمر هما الركيزة الأساسية التي تعزز من قدراتنا وتفتح لنا آفاقًا أوسع لنمو أعمالنا وخدمة عملائنا بأعلى جودة.
                        </p>
                    </div>
                </div>
