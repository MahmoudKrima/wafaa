...
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('user.recievers.index') }}">{{ __('admin.recievers') }}</a></li>
                ...
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-12 col-12 mx-auto">
                            <form action="{{ route('user.recievers.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="nameArInput" class="text-dark">{{ __('admin.name') }}</label>
                                            <input id="nameArInput" type="text" name="name" placeholder="{{ __('admin.name') }}" class="form-control" value="{{ old('name') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="phoneInput" class="text-dark">{{ __('admin.phone') }}</label>
                                            <input id="phoneInput" type="text" placeholder="05XXXXXXXX" name="phone" placeholder="{{ __('admin.phone') }}" style="direction:ltr;" class="form-control" value="{{ old('phone') }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" id="addressInput" type="text" name="address" placeholder="{{ __('admin.address') }}" class="form-control" value="{{ old('address') }}">
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        if (oldShippingCompanies && oldShippingCompanies.length > 0) {
            oldShippingCompanies.forEach(function(shippingCompany) {
