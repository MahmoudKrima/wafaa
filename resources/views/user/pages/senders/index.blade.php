...
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><span>{{ __('admin.senders') }}</span></li>
    </ol>
</nav>
@endpush
@section('content')
                ...
                <div class="widget-header">
                    <div class="row mt-2">
                        <div class="col-12" style="margin: 15px 15px 0 15px;">
                            <a href="{{ route('user.senders.create') }}"
                                ...
                                <div class="card-body">
                                    <div class="table-responsive mb-2">
                                        <div class="col-12 mx-auto border">
                                            <form action="{{ route('user.senders.search') }}" method="GET" class="p-3">
                                                <div class="row mt-2">
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4 style="padding: 30px 0px 15px 0px;">{{ trans('admin.senders') }}</h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-vcenter">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $sender->email }}</td>
                                    <td>{{ $sender->postal_code ?? __('admin.n/a') }}</td>
                                    <td class="text-center">
                                        <div class="action-btns d-flex justify-content-center">
                                            <a href="{{ route('user.senders.edit', $sender->id) }}"
                                            ...
                                            <form action="{{ route('user.senders.delete', $sender->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
