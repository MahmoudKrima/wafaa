...
class UpdateBankRequest extends FormRequest
{
    ...
    {
        return [
            "name_ar" => ["required", 'max:255', 'string', Rule::unique('banks', 'name->ar')->ignore($this->route('bank')->id)],
            "name_en" => ["required", 'max:255', 'string', Rule::unique('banks', 'name->en')->ignore($this->route('bank')->id)],
