...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'dateTo' => 'Date To',
        'isCod' => 'Is COD',
        'shippingCompanyId' => 'Shipping Company',
        'method' => 'Method',
        'status' => 'Status',
        'search' => 'Search',
        ...
        'sender_country_id' => 'Sender Country',
        'sender_country_name' => 'Sender Country Name',
        'sender_state_id' => 'Sender State',
        'sender_state_name' => 'Sender State Name',
        'sender_city_id' => 'Sender City',
        'sender_city_name' => 'Sender City Name',
        'sender_postal_code' => 'Sender Postal Code',
        'selected_receivers' => 'Selected Receivers',
        ...
        'total_per_receiver' => 'Total Per Receiver',
    ...
    | with something more reader friendly such as "Local" instead
