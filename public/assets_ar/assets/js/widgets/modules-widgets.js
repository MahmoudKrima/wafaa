try {
    ...
    */
    ...
    var spark1 = {
        ...
        series: [{
          data: [12, 14, 5, 47, 32, 44, 14, 55, 41, 69].reverse()
        }],
        stroke: {
          curve: 'smooth',
          width: 2,
    ...
    */
    ...
    var d_1options3 = {
      ...
      series: [{
        name: 'Sales',
        data: [28, 40, 36, 52, 38, 60, 38].reverse()
      }],
    ...
    events: {
      mounted: function(ctx, config) {
        ...
        ctx.addPointAnnotation({
          ...
          customSVG: {
              SVG: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#F6950D" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>',
              cssClass: undefined,
              offsetX: -8,
              offsetY: 5
          }
